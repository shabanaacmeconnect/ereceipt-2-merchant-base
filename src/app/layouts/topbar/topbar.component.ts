...
export class TopbarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.initForm();
    this.logo=this.authFackservice.currentUserValue['logo']
    this.configData = {
  ...
  typeSubmit() {
    ...
    this.authFackservice.postMultipart('merchants/change-password',this.typeValidationForm.value).subscribe(
      res => {
        if(res['status']==true){
